    ...
    return ( 
        <div className='container'>
            <div className='p-5'>
                ...
                <div className='row'>
                    <p className='col-md-3'>Get your Bussiness Ideas Implemented in latest techonologies!!</p>
                ...
                <div className='d-flex justify-content-between flex-row align-items-end pt-4 row gy-4'>
                    <div className='d-flex flex-row justify-content-between align-items-center col-md-4'>
                        ...
                        <img src='assets/images/secp.png' className='footer-secp-img '/>
                    </div>
                    <p className='col-md-4'>Codify (PVT) Limited</p>                    
                </div>
            </div>
